<template>
  <div>
    <div class="text-center mt-5 pb-5">
      <h2 class="text-white" v-text="$t('portfolioDevTranslate.aboutProgress.experiences')"></h2>
      <span class="border-bottom border-3 border-success d-block mx-auto" style="width: 5%;"></span>
    </div>
    <div class="d-grid container text-white text-center mt-sm-5">
      <div class="row">
        <div class="col-12 col-sm-6 mb-4">
          <div class="card bg-transparent text-start border-dark rounded p-4">
            <p class="badge text-success text-start font-weight-400">Jan/2021 - Fev/2021</p>
            <div>
        ...
        <div class="col-12 col-sm-6 mb-4">
          <div class="card bg-transparent text-start border-dark rounded p-4">
            ...
            <p>
              ...
              <br>
              <b>Stacks:</b>
              VueJs, Typescript, Spring Boot, Java, Oracle
            </p>
          </div>
        </div>
      </div>
